...
export const POWER_STATION_PROXIMITY_RADIUS = 2; // cells within this radius produce only small asteroids
export const MARKET_PROXIMITY_RADIUS = 1; // cells within this radius produce no asteroids
