...
describe('SellResourcesCommand', () => {
    it('adds creditsDelta to credits', () => {
        ...
        const transaction = { creditsDelta: 500, itemsSold: { Fe: 10 } };

        new SellResourcesCommand(state$, transaction).execute();
    ...
    it('clears inventory', () => {
        ...
        const transaction = { creditsDelta: 500, itemsSold: { Fe: 10, Ni: 5 } };
    ...
    it('reads state at execute time, not construction time', () => {
        ...
        const transaction = { creditsDelta: 500, itemsSold: { Fe: 10 } };
        const command = new SellResourcesCommand(state$, transaction);
